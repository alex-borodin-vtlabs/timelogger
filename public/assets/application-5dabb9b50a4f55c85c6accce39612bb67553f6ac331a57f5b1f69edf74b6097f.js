...
angular.module('app', ['ngResource', 'ngRoute'])
    .config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
        ...
        $routeProvider
            .when('/', {controller: 'ProjectIndexController',    templateUrl: '/assets/angular/templates/index-09bbee84d011e6ae445ce5c3f65be7a5cb0fc6e293a5fdecddab9d1b74ccb03b.html'})
    ...
    $scope.create = function(project) {
		...
		$scope.updating = true;
     	project.$save(project, function(response) {
			...
			{
				$scope.createForm.title.$setValidity("response", false);
			}			
		});
	}; 
});
